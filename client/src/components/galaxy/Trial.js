...
class Trial extends Component {
  ...
  renderChildButtons() {
    ...
    console.log("1", targetButtonStylesInitObject);
    //StaggeredMotion now takes an Array of object
    const targetButtonStylesInit = targetButtonStylesInitObject;// Object.keys(targetButtonStylesInitObject).map(key => targetButtonStylesInitObject[key]);
    // console.log("2", targetButtonStylesInitObject);
    ...
    console.log("3", targetButtonStyles);
...
export default connect(null, null)(Trial);